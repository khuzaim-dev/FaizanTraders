            ...
            <form name="contact" method="POST" data-netlify="true" className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="name" name="name" type="text" required className="w-full pl-10 pr-4 py-2 border border-zinc-300 dark:border-zinc-700 rounded-md bg-transparent dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none" placeholder="Ali Khan" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="phone" name="phone" type="text" required className="w-full pl-10 pr-4 py-2 border border-zinc-300 dark:border-zinc-700 rounded-md bg-transparent dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none" placeholder="+92 300 1234567" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea id="requirements" name="requirements" required rows={4} className="w-full pl-10 pr-4 py-2 border border-zinc-300 dark:border-zinc-700 rounded-md bg-transparent dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none" placeholder="I am looking for a 2021 Toyota Aqua..."></textarea>
                </div>
              </div>
              <button type="submit" className="w-full py-3 bg-red-600 text-white font-bold rounded-md hover:bg-red-700 transition-colors">
                Send Inquiry
              </button>
            </form>
          </div>
